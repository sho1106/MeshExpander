...
| **Tight fit** | Per-box local face normals cut 36–64% of ConservativeExpander's volume for real meshes |
...
Input mesh (any topology)
  │
  1. VoxelGrid::build()        Conservative triangle-AABB voxelization
  │                            cell size = fixed world value or AABB / resolution
  2. VoxelGrid::greedyMerge()  Decompose occupied voxels into non-overlapping boxes
  │                            (concavities preserved — interior air voxels left empty)
...
│   ├── VoxelGrid.hpp           Voxelization + greedy box merging
...
| VoxelGrid | 8 | Voxelization, greedy merge |
